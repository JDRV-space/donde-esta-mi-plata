...
---
${language === 'en' ? 'Draft generated by the Donde Esta Mi Plata prototype.' : 'Borrador generado por el prototipo Donde Esta Mi Plata.'}
...
`.trim();
    ...
    // Prototype placeholder: verify the real municipality address before sending.
        ...
        <div className="p-4 flex-1 flex flex-col gap-4 font-mono pb-32">
          ...
          <div className="bg-gray-100 border-2 border-gray-300 p-3 text-xs">
            ...
            <p className="text-gray-500 mt-1 italic text-[10px]">
                {language === 'en'
                    ? '* Placeholder email. Verify the real municipality address before sending.'
                    : '* Email de ejemplo. Verifica la direccion real del municipio antes de enviar.'}
            </p>
          </div>
